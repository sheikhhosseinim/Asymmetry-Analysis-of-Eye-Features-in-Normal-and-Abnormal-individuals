...
def BCOSFIRE(img_rgb, mask=[]):
	...
	cosfire_symm = c.COSFIRE(
		c.CircleStrategy(c.DoGFilter, (4.8, 1), prototype=proto_symm, center=(cx,cy), rhoList=range(0,19,2), sigma0=3,  alpha=0.2,
	...
	cosfire_asymm = c.COSFIRE(
			c.CircleStrategy(c.DoGFilter, (4.7, 1), prototype=proto_symm, center=(cx,cy), rhoList=range(0,27,2), sigma0=2,  alpha=0.1,
...
if __name__ == '__main__':
    ...
    for subj_idx in range(90):
        ...
        image_path=data_path+'/fundus_left_aligned.jpg'
        ...
        filename=data_path +'/fundus_vessel_left.jpg'
        plt.imsave(filename,p_vessel,cmap='gray')

        plt.imshow(p_vessel,cmap='gray')
        plt.show()
        
        image_path=data_path+'/fundus_right_aligned.jpg'
        img_rgb = cv2.cvtColor(cv2.imread(image_path), cv2.COLOR_BGR2RGB)
        ...
        filename=data_path +'/fundus_vessel_right.jpg'
        plt.imsave(filename,p_vessel,cmap='gray')
